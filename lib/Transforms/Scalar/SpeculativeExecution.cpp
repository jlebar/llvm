...
class SpeculativeExecution : public FunctionPass {
 ...
 private:
  ...
  // divergence.
  const bool OnlyIfDivergentArch;
...
bool SpeculativeExecution::runOnFunction(Function &F) {
  ...
  if (OnlyIfDivergentArch && !TTI->hasBranchDivergence()) {
...
FunctionPass *createSpeculativeExecutionIfHasBranchDivergencePass() {
  return new SpeculativeExecution(/* OnlyIfDivergentArch = */ true);
}
